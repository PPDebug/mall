...
public class SmsFlashPromotionProductSessionController {
    ...
    @ResponseBody
    public CommonResult<List<SmsFlashPromotionSessionDetail>> selectList(@Validated @NotEmpty @RequestParam Long flashPromotionId) {
